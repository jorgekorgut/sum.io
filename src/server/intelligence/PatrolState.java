...
/*
 * This class search for a patrol point to avoid idle state.
 */

public class PatrolState extends AbstractFSMState
{
	private GameObject target;
	
	public PatrolState(PlayerBot player, GameObject target) 
	{
		super(player);
		this.target = target;
	}
